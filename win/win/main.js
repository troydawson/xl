...
function GetCanvas2D() {
    ...
    if (!canvas2D || !canvas2D.getContext('2d')) {
        return null;
    }
    return canvas2D;
}
...
function OnCanvasFailed(canvasElement, elementId) {
    var cnvContainer = document.getElementById('WebGLCanvasContainer');
    cnvContainer.style.backgroundColor = "#EAEAEA";
    cnvContainer.style.textAlign = "center";
    cnvContainer.innerHTML = '<p class="CanvasErrorText">Sorry, your browser does not support WebGL</p>';
}
...
function OnCanvas2DFailed() {
    ...
    cnvContainer.style.backgroundColor = "#EAEAEA";
    cnvContainer.style.textAlign = "center";
    cnvContainer.innerHTML = '<p class="CanvasErrorText">Sorry, your browser does not support HTML5 canvas</p>';
}
